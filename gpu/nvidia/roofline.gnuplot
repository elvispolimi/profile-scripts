...
if (precision eq "dp") {
    ...
    thread_fp_performance = thread_performance_int
    l1_thread_fp_intensity = l1_thread_intensity_int
    l2_thread_fp_intensity = l2_thread_intensity_int
    hbm_thread_fp_intensity = hbm_thread_intensity_int
