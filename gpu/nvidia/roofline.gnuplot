...
plot \
	...
	[0:0:1] "+" us (-10):(-10) \
		with points lc rgb "black" pt point - 1 ps point_size title 'exe',\
	[0:0:1] "+" us (l1_thread_fp_intensity):(thread_fp_performance) with points lc rgb l1_color pt point ps point_size title "L1",\
	[0:0:1] "+" us (l2_thread_fp_intensity):(thread_fp_performance) with points lc rgb l2_color pt point ps point_size title "L2",\
	[0:0:1] "+" us (hbm_thread_fp_intensity):(thread_fp_performance) with points lc rgb hbm_color pt point ps point_size title "HBM"
